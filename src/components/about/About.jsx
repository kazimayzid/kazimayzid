  ...
  return (
    <>
      <Container>
        <div
          data-aos="fade-up"
          className="flex flex-col items-center mt-[95px] mb-[110px]"
        >
          <h1 className="font-inter font-extrabold text-[45px] text-[#2B2B2B]">
            About Me
          </h1>
          ...
          <div className="flex flex-col justify-center items-center">
            <span className="font-inter font-medium text-[17px] sm:text-[17px] leading-[25px] sm:leading-[30px] text-[#1C1E53] text-center max-w-[90%] sm:max-w-[790px]">
            ...
            <span className="font-inter font-medium text-[17px] sm:text-[17px] leading-[25px] sm:leading-[30px] text-[#1C1E53] text-center max-w-[90%] sm:max-w-[790px] my-1">
