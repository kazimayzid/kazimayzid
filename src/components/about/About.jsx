      ...
      <Container>
        ...
        >
          ...
          <div className="flex flex-col justify-center items-center">
            <span className="font-inter font-medium text-[17px] sm:text-[17px] leading-[25px] sm:leading-[30px] text-detailsColor text-center max-w-[90%] sm:max-w-[790px]">
            ...
            <span className="font-inter font-medium text-[17px] sm:text-[17px] leading-[25px] sm:leading-[30px] text-detailsColor text-center max-w-[90%] sm:max-w-[790px] my-1">
